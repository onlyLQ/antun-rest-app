...
import com.qing.bigdata.antun.web.response.BaseResponse;
import com.qing.bigdata.antun.web.validation.UserValidation;
...
public class UserController extends BaseResponse{
	...
	public BaseResponse addUser(UserAdd userAdd){
		...
		//执行业务
		int len = userService.addUser(userAdd);
		return successResponse("入库成功，数量："+len);
	}
	/**
	 * id查询
	 * @param id
